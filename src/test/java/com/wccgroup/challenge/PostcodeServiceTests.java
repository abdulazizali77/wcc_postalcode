...
public class PostcodeServiceTests {
    ...
    void getSuccess() {
        ...
        assert (pc.coordinate.getLatitude() == 57.168438);
        assert (pc.coordinate.getLongitude() == -2.161636);
    }
    ...
    void testDistanceSuccess() {
        ...
        Double d = distanceService.calculateDistance(postcode1.coordinate.getLatitude(), postcode1.coordinate.getLongitude(),
